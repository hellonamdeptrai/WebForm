                  ...
                  <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                    <div class="card profile-greeting">
                      ...
                      <div class="card-body text-center p-t-0">
                        <h3 class="font-light">Xin chào <%: item.Name %></h3>
                        <p>Chào mừng bạn đến với trang quản trị xịn nhất mọi thời đại</p>
                      </div>
                        <%} %>
                      <div class="confetti">
                  ...
                  <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                    <div class="card income-card card-primary">                                 
                      <div class="card-body text-center">                                  
                        ...
                        <p>Tổng đơn hàng đã giao</p><a class="btn-arrow arrow-primary" href="javascript:void(0)"><i class="toprightarrow-primary fa fa-arrow-up me-2"></i></a>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                    <div class="card income-card card-secondary">                                    
                      <div class="card-body text-center">
                        ...
                        <h5>
                            <asp:Label ID="txtTotalMoney" runat="server"></asp:Label>
                        </h5>
                        <p>Tổng tiền thu về</p><a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i class="toprightarrow-secondary fa fa-arrow-up me-2"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
